...
const arr = [7, 8, 9];
const newArr = [1, 2, ...arr]; // Spread Operator take all the elements in array put them manually as use write them individually
console.log(newArr);
// passing individually 
console.log(...newArr);

//add new element to menu 
...
//call function for pasta ingridiance
//prompt
...
//
//The Spread Operator(...) Chalengess
//
...
//
//Destructuring Arrays Challenges 
//
